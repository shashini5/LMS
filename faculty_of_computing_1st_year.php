<html> 
<head>
<title> Faculty of Computing First Year </title>
...
<div id="module_topic">
<p> Faculty of Computing First Year Modules & Courses </p>
</div>
...
$a="SELECT module_code,module_name FROM modules_com_1 WHERE module_no=1";
...
echo '<p style="text-align:center;font-family:verdana;margin-top:10px"><a href="computer_year1_m1.php" style="color:#FF5500;text-decoration:none">'.$data[1].'</a></p>';
?>
</div>
<!-- Module 1 Code End -->
...
<?php
$link=mysqli_connect('localhost','root','','web_lms');
$a="SELECT module_code,module_name FROM modules_com_1 WHERE module_no=2";
$sql=mysqli_query($link,$a);
$data=mysqli_fetch_array($sql);
echo '<p style="font-family:verdana;float:left;margin-left:30px;margin-top:10px;color:#FF5500">'.$data[0].'</p>';
echo '<p style="text-align:center;font-family:verdana;margin-top:10px"><a href="computer_year1_m2.php" style="color:#FF5500;text-decoration:none">'.$data[1].'</a></p>';
?>
</div>
<!-- Module 2 Code End -->
...
<?php
$link=mysqli_connect('localhost','root','','web_lms');
$a="SELECT module_code,module_name FROM modules_com_1 WHERE module_no=3";
$sql=mysqli_query($link,$a);
$data=mysqli_fetch_array($sql);
echo '<p style="font-family:verdana;float:left;margin-left:30px;margin-top:10px;color:#FF5500">'.$data[0].'</p>';
echo '<p style="text-align:center;font-family:verdana;margin-top:10px"><a href="computer_year1_m3.php" style="color:#FF5500;text-decoration:none">'.$data[1].'</a></p>';
?>
</div>
<!-- Module 3 Code End -->
...
<?php
$link=mysqli_connect('localhost','root','','web_lms');
$a="SELECT module_code,module_name FROM modules_com_1 WHERE module_no=4";
$sql=mysqli_query($link,$a);
$data=mysqli_fetch_array($sql);
echo '<p style="font-family:verdana;float:left;margin-left:30px;margin-top:10px;color:#FF5500">'.$data[0].'</p>';
echo '<p style="text-align:center;font-family:verdana;margin-top:10px"><a href="computer_year1_m4.php" style="color:#FF5500;text-decoration:none">'.$data[1].'</a></p>';
?>
</div>
<!-- Module 4 Code End -->
...
<?php
$link=mysqli_connect('localhost','root','','web_lms');
$a="SELECT module_code,module_name FROM modules_com_1 WHERE module_no=5";
$sql=mysqli_query($link,$a);
$data=mysqli_fetch_array($sql);
echo '<p style="font-family:verdana;float:left;margin-left:30px;margin-top:10px;color:#FF5500">'.$data[0].'</p>';
echo '<p style="text-align:center;font-family:verdana;margin-top:10px"><a href="computer_year1_m5.php" style="color:#FF5500;text-decoration:none">'.$data[1].'</a></p>';
?>
</div>
<!-- Module 5 Code End -->
...
<?php
$link=mysqli_connect('localhost','root','','web_lms');
$a="SELECT module_code,module_name FROM modules_com_1 WHERE module_no=6";
$sql=mysqli_query($link,$a);
$data=mysqli_fetch_array($sql);
echo '<p style="font-family:verdana;float:left;margin-left:30px;margin-top:10px;color:#FF5500">'.$data[0].'</p>';
echo '<p style="text-align:center;font-family:verdana;margin-top:10px"><a href="computer_year1_m6.php" style="color:#FF5500;text-decoration:none">'.$data[1].'</a></p>';
?>
</div>
<!-- Module 6 Code End -->
...
<?php
$link=mysqli_connect('localhost','root','','web_lms');
$a="SELECT module_code,module_name FROM modules_com_1 WHERE module_no=7";
$sql=mysqli_query($link,$a);
$data=mysqli_fetch_array($sql);
echo '<p style="font-family:verdana;float:left;margin-left:30px;margin-top:10px;color:#FF5500">'.$data[0].'</p>';
echo '<p style="text-align:center;font-family:verdana;margin-top:10px"><a href="computer_year1_m7.php" style="color:#FF5500;text-decoration:none">'.$data[1].'</a></p>';
?>
</div>
<!-- Module 7 Code End -->
...
<?php
$link=mysqli_connect('localhost','root','','web_lms');
$a="SELECT module_code,module_name FROM modules_com_1 WHERE module_no=8";
$sql=mysqli_query($link,$a);
$data=mysqli_fetch_array($sql);
echo '<p style="font-family:verdana;float:left;margin-left:30px;margin-top:10px;color:#FF5500">'.$data[0].'</p>';
echo '<p style="text-align:center;font-family:verdana;margin-top:10px"><a href="computer_year1_m8.php" style="color:#FF5500;text-decoration:none">'.$data[1].'</a></p>';
?>
</div>
<!-- Module 8 Code End -->
...
<?php
$link=mysqli_connect('localhost','root','','web_lms');
$a="SELECT module_code,module_name FROM modules_com_1 WHERE module_no=9";
$sql=mysqli_query($link,$a);
$data=mysqli_fetch_array($sql);
echo '<p style="font-family:verdana;float:left;margin-left:30px;margin-top:10px;color:#FF5500">'.$data[0].'</p>';
echo '<p style="text-align:center;font-family:verdana;margin-top:10px"><a href="computer_year1_m9.php" style="color:#FF5500;text-decoration:none">'.$data[1].'</a></p>';
?>
</div>
<!-- Module 9 Code End -->
...
<?php
$link=mysqli_connect('localhost','root','','web_lms');
$a="SELECT module_code,module_name FROM modules_com_1 WHERE module_no=10";
$sql=mysqli_query($link,$a);
$data=mysqli_fetch_array($sql);
echo '<p style="font-family:verdana;float:left;margin-left:30px;margin-top:10px;color:#FF5500">'.$data[0].'</p>';
echo '<p style="text-align:center;font-family:verdana;margin-top:10px"><a href="computer_year1_m10.php" style="color:#FF5500;text-decoration:none">'.$data[1].'</a></p>';
?>
</div>
<!-- Module 10 Code End -->
...
<?php
$link=mysqli_connect('localhost','root','','web_lms');
$a="SELECT module_code,module_name FROM modules_com_1 WHERE module_no=11";
$sql=mysqli_query($link,$a);
$data=mysqli_fetch_array($sql);
echo '<p style="font-family:verdana;float:left;margin-left:30px;margin-top:10px;color:#FF5500">'.$data[0].'</p>';
echo '<p style="text-align:center;font-family:verdana;margin-top:10px"><a href="computer_year1_m11.php" style="color:#FF5500;text-decoration:none">'.$data[1].'</a></p>';
?>
</div>
<!-- Module 11 Code End -->
...
<?php
$link=mysqli_connect('localhost','root','','web_lms');
$a="SELECT module_code,module_name FROM modules_com_1 WHERE module_no=12";
$sql=mysqli_query($link,$a);
$data=mysqli_fetch_array($sql);
echo '<p style="font-family:verdana;float:left;margin-left:30px;margin-top:10px;color:#FF5500">'.$data[0].'</p>';
echo '<p style="text-align:center;font-family:verdana;margin-top:10px"><a href="computer_year1_m12.php" style="color:#FF5500;text-decoration:none">'.$data[1].'</a></p>';
?>
</div>
<!-- Module 12 Code End -->
...
<?php
$link=mysqli_connect('localhost','root','','web_lms');
$a="SELECT module_code,module_name FROM modules_com_1 WHERE module_no=13";
$sql=mysqli_query($link,$a);
$data=mysqli_fetch_array($sql);
echo '<p style="font-family:verdana;float:left;margin-left:30px;margin-top:10px;color:#FF5500">'.$data[0].'</p>';
echo '<p style="text-align:center;font-family:verdana;margin-top:10px"><a href="computer_year1_m13.php" style="color:#FF5500;text-decoration:none">'.$data[1].'</a></p>';
?>
</div>
<!-- Module 13 Code End -->
...
<?php
$link=mysqli_connect('localhost','root','','web_lms');
$a="SELECT module_code,module_name FROM modules_com_1 WHERE module_no=14";
$sql=mysqli_query($link,$a);
$data=mysqli_fetch_array($sql);
echo '<p style="font-family:verdana;float:left;margin-left:30px;margin-top:10px;color:#FF5500">'.$data[0].'</p>';
echo '<p style="text-align:center;font-family:verdana;margin-top:10px"><a href="computer_year1_m14.php" style="color:#FF5500;text-decoration:none">'.$data[1].'</a></p>';
?>
</div>
<!-- Module 14 Code End -->
...
<?php
$link=mysqli_connect('localhost','root','','web_lms');
$a="SELECT module_code,module_name FROM modules_com_1 WHERE module_no=15";
$sql=mysqli_query($link,$a);
$data=mysqli_fetch_array($sql);
echo '<p style="font-family:verdana;float:left;margin-left:30px;margin-top:10px;color:#FF5500">'.$data[0].'</p>';
echo '<p style="text-align:center;font-family:verdana;margin-top:10px"><a href="computer_year1_m15.php" style="color:#FF5500;text-decoration:none">'.$data[1].'</a></p>';
?>
</div>
<!-- Module 15 Code End -->
...
<div id="mod_set_bak">
<div id="mod_set_form">
<form action="com_1_module_setting.php" method="POST" >
...
<div id="mod_del_bak">
<div id="mod_del_form">
<form action="com_1_module_delete.php" method="POST" >
